...
if ((isset($_POST["submitted_form"])) && ($_POST["submitted_form"] == "image_upload_form")) {
	...
	if (($_FILES["image_upload_box"]["type"] == "image/jpeg" || $_FILES["image_upload_box"]["type"] == "image/pjpeg" || $_FILES["image_upload_box"]["type"] == "image/gif" || $_FILES["image_upload_box"]["type"] == "image/png") && ($_FILES["image_upload_box"]["size"] < 2097152))
	{
		...
		header("Location: de-success.php?upload_message=image uploaded&upload_message_type=success&show_image=".$_FILES["image_upload_box"]["name"]);
		exit;
	}
	else{
...
<div id="wrapper">
		<div id="top-first">
			<img src="graphics/logo-de.png" alt="coenizr" /><br />
		...
		<br />
		<span>1. Ich wähle mein Foto </span>
			<br />
		<img src="graphics/arrows.png" alt="mode de sélection" />
		<br />
	<div id="mode-container">
		<div class="upload-mode-container">
			<span style="width:250px">Ein Bild von meinem Computer </span>
			<div id="infos-upload">(Bilder max. 2MB, .jpg, .gif oder .png)</div>
			<br />
			<div id="classic-select">
				<form action="de-submit1.php" method="POST" enctype="multipart/form-data" name="image_upload_form" id="image_upload_form" style="padding-top: 5em;">
					<input name="image_upload_box" type="file" id="image_upload_box" size="20" />
					<input type="image" name="submit" src="graphics/de-classic-upload.png" value="Upload image" style="padding-top: 15px;"/>
		...
		<div class="upload-mode-container">
			<span style="width:250px">Aus meinen Alben bei Facebook</span>
			<div id="infos-upload">(Anwendung zulassen, auswählen, abschicken)</div>
			
				<br />
			<div id="fb-select">
   			 <img src="graphics/de-login_btn.png" id="btnLogin" style="padding-top: 6.5em;"/>
				
				<a href="#" class="photoSelect">
				<img src="graphics/de-fb-upload.png" id="choisir" style="padding-top: 67px; border:0" />
				</a>
				<form action="de-successfb.php" method="POST" enctype="multipart/form-data" name="form_fb" id="form_fb"  style="padding-top: 10px;">
					<input type="image" id="envoyer" src="de-graphics/send_btn.png" name="submit" value="Envoi" />     
